# Prisma SD-WAN Virtual ION on OCI - Reference Architecture (Draft)

We are using hub-and-spoke architecture (often called as star topology), dynamic routing gateway with Prisma SDWAN ION Solution. This architecture has a central component (the hub) that's connected to multiple networks around it, like a spoke. 

**Note**: We are using custom image but BOYL Listing from OCI Marketplace will be available soon.
...
We have validated **update version** Prisma SDWAN ION for this architecture.
...
1. **Click - Fix this** [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)]()
...
8. At this stage your architecture should have been deployed successfully. You can proceed to next section for configuring your Prisma SDWAN ION Application VM.
...
1. Create a local copy of this repo using below command on your terminal: 
    ...
    ```
    git clone https://github.com/oracle-quickstart/oci-prisma-sdwan.git
    cd oci-prisma-sdwan/drg-use-case/
    ls
    ```
...
3. Create a `terraform.tfvars` file in your **drg-use-case** directory, and specify the following variables:
    ...
    # Prisma
    prisma_sdwan_custom_image_ocid = "<prisma_sdwan_ion_custom_image_ocid>"
...
5. At this stage your architecture should have been deployed successfully. You can proceed to next section for configuring your Prisma SDWAN ION VM. 
